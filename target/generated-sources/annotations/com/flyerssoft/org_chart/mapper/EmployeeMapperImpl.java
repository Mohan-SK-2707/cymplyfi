...
public class EmployeeMapperImpl implements EmployeeMapper {
    ...
    @Override
    public List<EmployeeDepartmentDto> departmentEntityListToDto(List<EmployeeDepartment> departments) {
        if ( departments == null ) {
            return null;
        }

        List<EmployeeDepartmentDto> list = new ArrayList<EmployeeDepartmentDto>( departments.size() );
        for ( EmployeeDepartment employeeDepartment : departments ) {
            list.add( departmentEntityToDto( employeeDepartment ) );
        }
    ...
    @Override
    public List<EmployeePersonalDetailDto> employeePersonalDetailEntityListToDto(List<EmployeePersonalDetails> employees) {
        if ( employees == null ) {
            return null;
        }

        List<EmployeePersonalDetailDto> list = new ArrayList<EmployeePersonalDetailDto>( employees.size() );
        for ( EmployeePersonalDetails employeePersonalDetails : employees ) {
            list.add( entityToDto( employeePersonalDetails ) );
        }
